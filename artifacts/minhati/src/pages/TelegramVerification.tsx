...
export default function TelegramVerification({ nin, nni, onVerified, onSkip }: TelegramVerificationProps) {
    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-background">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground text-sm">فعّل التنبيهات لتتلقى إشعارات فورية عند أي تحديث</p>
        </div>
            ...
            <div className="space-y-6">
              ...
              <div className="border-t border-border pt-5">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center justify-center gap-3 w-full py-3 px-6 bg-[#2ca5e0] text-white font-bold rounded-lg hover:opacity-90 transition-opacity shadow-lg mb-3"
                >
                ...
                <button
                  onClick={onSkip}
                  className="w-full py-3 px-6 bg-transparent border border-border text-muted-foreground font-semibold rounded-lg hover:bg-muted/30 hover:text-foreground transition-all duration-150 text-sm"
                >
                  تخطي — المتابعة بدون تنبيهات
                </button>
              </div>
